...
import Bonus from "./Steps/Bonus";
import SalaryRevision from "./Steps/SalaryRevision";
import Overtime from "./Steps/Overtime";
import ShiftAllowance from "./Steps/ShiftAllowance";
...
export default function SalaryRevisionStepper() {
