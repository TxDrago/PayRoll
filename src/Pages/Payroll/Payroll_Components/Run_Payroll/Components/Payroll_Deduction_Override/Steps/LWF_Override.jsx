  ...
  const columns = [
    {
      ...
      renderCell: (params) => {
        ...
        return <span className="text-xs text-[#818181]">{empId}</span>;
      },
    },
    {
      field: "employee",
    ...
    {
      field: "Regular_PT",
      headerName: "Regular LWF",
      flex: 0.7,
      renderCell: (params) => params.row.Regular_PT || "-",
    },
    {
      field: "Amount",
      headerName: "LWF Override Amount",
      flex: 1,
      renderCell: (params) => {
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full bg-[#EBF1FF] border-2 border-[#005377] text-[#19396F] font-normal text-[16px] rounded-xl py-2 px-3 font-poppins">
          All LWF overrides that were added for this month will be shown here.
          New overrides can be added as well from here
        </div>
      </div>
