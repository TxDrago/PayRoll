...
const handleInputChange = (id, value) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "Adhoc Deduction Type",
      flex: 1,
      renderCell: (params) => (
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full bg-[#EBF1FF] border-2 border-[#005377] text-[#19396F] font-normal text-[16px] rounded-xl py-2 px-3 font-poppins">
          Adhoc deductions that are supposed to be deducted from the employees
          salary in this month, can be managed below.
        </div>
      </div>
