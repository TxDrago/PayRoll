    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <div className="w-full bg-[#EBF1FF] border-2 border-[#005377] text-[#19396F] font-normal text-[16px] rounded-xl py-2 px-3 font-poppins">
          In case of employees who are absconding or are on uninformed leave,
          you might want to hold/stop the processing of their salary. Use the
          "Salary processing on hold" option to stop/hold the processing of
          salary for selected employees. They will also be excluded from
          statutory contribution/deduction calculation and will only be
          considered if you decide to process their salary in the future.
        </div>
      </div>
