...
import LeaveEncashment_Modal from "./Components/LeaveEncashment_Modal";
...
// Main Component
const LeaveEncashment_Settings = () => {
    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: "40px" }}>
                  ...
                  >
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                     ...
                     Leave Encashment Policies
                      ...
                      >
                      This list contains all the ad-hoc salary components (one time payments and deductions) that gets paid out/deducted in your organization
                      </Typography>
                    </Box>
                    ...
                    <Box>
                      ...
                      >
                        <span>Add Encashment Policy</span>
                      </Button>
                    </Box>
                  </Box>
                </Box>
      ...
      >
        ...
        >
          ...
          <MenuItem onClick={() => handleMenuClick("Edit")}>Set as Default</MenuItem>
          <MenuItem onClick={() => handleMenuClick("Delete")}>Delete Policy</MenuItem>
        </Menu>
...
export default LeaveEncashment_Settings;
