...
import NoticePeriodBuyout_Modal from "./Components/NoticePeriodBuyout_Modal";
...
// Main Component
const NoticePeriodBuyout_Settings = () => {
  ...
  const columns = [
    ...
    {
      field: "Loan_Amount",
      headerName: "Buy Out Calculation",
      flex: 1,
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: "40px" }}>
          ...
          <Box>
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                ...
                >
                  In this practice, the hiring company buys out the employee
                  prior to the notice period expiring.
                </Typography>
              </Box>
      ...
      {/* Add and Edit Modal */}
      <NoticePeriodBuyout_Modal open={open} onClose={() => setOpen(false)} />
    </Box>
  );
};

export default NoticePeriodBuyout_Settings;
